...
typedef union {
  ...
  unsigned char line[10][16];
  unsigned char text_msg[MSG_LENGTH];
} message;
...
unsigned char msg_getisEmptyFree(unsigned char index);
...
void msg_setisEmptyFree(unsigned char index, unsigned char isEmptyFree);
