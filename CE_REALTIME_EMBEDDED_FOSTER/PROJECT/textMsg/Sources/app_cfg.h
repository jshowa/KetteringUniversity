...
#define  SEVEN_SEG_TEST_TASK_PRIO          15//4                        /* Set the prio for Seven Segment Test Task                 */
...
#define  INC_MINUTE_TASK_PRIO              13                           /* Set the priority of the increment minute task -jsw       */ 
#define  INC_HOUR_TASK_PRIO                14                           /* Set the priority of the hour task -jsw                   */
...
#define TIME_MUTEX_PRIO                    12                           /* 12 is higher than the min, hour, and display task (13,14,15) -jsw */
/*
*********************************************************************************************************
*                                    TASK STACK SIZES!
*********************************************************************************************************
...
#define  MINUTE_TASK_STK_SIZE             256                           /* Set the stack size for the MinuteTask -jsw */
#define  HOUR_TASK_STK_SIZE               256                           /* Set the stack size for the HourTask -jsw */
/*
*********************************************************************************************************
