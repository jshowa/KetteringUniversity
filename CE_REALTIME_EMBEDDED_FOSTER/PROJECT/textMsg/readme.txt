...
- P&E Multilink/Cyclone Pro:
  This Connection allows to debug with the P&E BDM Multilink (USB and parallel) 
  or P&E Cyclone Pro (USB, Serial and TCP/IP)..
  Please check the P&E hardware documentation for additional details.
